            ...
            <div className="p-6 sm:p-8 md:p-9">
              <div className="w-full">
                ...
                {authProviders.slack ? (
                  <button
                    type="button"
                    className="mt-7 inline-flex w-full max-w-[360px] items-center justify-center gap-3 rounded-full border border-[#d3dbe6] bg-white px-6 py-3 text-[#111827] shadow-sm transition hover:bg-slate-50"
                    onClick={api.loginWithSlack}
                    aria-label="Sign in with Slack"
                  >
                    <img src="/slack.png" alt="" className="h-7 w-7 object-contain" />
                    <span className="text-[1.125rem] font-semibold leading-none">Sign in with Slack</span>
                  </button>
